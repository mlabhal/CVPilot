  ...
  const handleFileSelect = (event: React.ChangeEvent<HTMLInputElement>) => {
    if (event.target.files) {
      ...
      if (selectedFiles.length + filesArray.length > MAX_CV_COUNT) {
        ...
        // Optionnel: prendre uniquement les premiers fichiers jusqu'à la limite
        // const allowedFiles = filesArray.slice(0, MAX_CV_COUNT - selectedFiles.length);
  ...
  return (
    <div className="min-h-screen bg-transparent pt-20 ">
      <div className="container mx-auto">
          <div className="p-8">
            <h1 className="text-3xl font-bold text-white mb-8">Analyseur de CV</h1>
